          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8 md:gap-10 mb-12 md:mb-16">
            <div className="bg-white p-6 sm:p-8 md:p-10 rounded-2xl md:rounded-3xl shadow-lg md:shadow-xl">
              ...
              <p className="text-gray-600 text-base sm:text-lg">
                Использую технологии, которые сегодня востребованы на рынке:
                Vite, Tailwind, React, Node.js. Глубокое понимание
            ...
            <div className="bg-white p-6 sm:p-8 md:p-10 rounded-2xl md:rounded-3xl shadow-lg md:shadow-xl">
              ...
              <p className="text-gray-600 text-base sm:text-lg">
                Каждый изучаемый инструмент сразу применяю в реальных проектах,
                создавая работающие решения. Накопление портфолио и
                практического опыта.
              </p>
            </div>
          </div>
