...
const projects = [
  ...
  { 
    ...
    description: 'Вы получаете специалиста, который работает с современными технологиями, востребованными на рынке. Я использую актуальный стек: React с хуками и контекстом, TypeScript, Tailwind CSS и Vite — инструменты, которые сегодня применяются в реальных коммерческих проектах.' +
                ...
                '\n\n' +
                'Вы получаете разработчика с актуальным образованием (3 курс IT-колледжа) и практическими навыки. Я не только пишу код, но и понимаю архитектурные принципы, слежу за лучшими практиками и готов внедрять их в ваши проекты с учетом последних трендов веб-разработки.'
  },
  { 
    id: 3, 
    title: 'Почему я', 
